...
from calb_sizing_tool.infra.db.models import ExternalArtifactSubmission
...
from calb_sizing_tool.services.external_layout_service import submit_external_layout_artifact
...
def test_external_artifact_submission_flow(sample_excel_path, tmp_path):
    db_url = f"sqlite:///{(tmp_path / 'external_submission.sqlite').as_posix()}"
    ...
    stage1_inputs = {
        "project_name": "External Submit Test",
