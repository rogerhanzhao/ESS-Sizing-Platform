...
class RunOutputSnapshot(Base, TimestampMixin, SourceVersionMixin):
    __tablename__ = "run_output_snapshot"

    run_output_snapshot_id: Mapped[str] = mapped_column(String(36), primary_key=True, default=new_uuid)
