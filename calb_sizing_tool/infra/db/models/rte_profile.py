...
class RteProfile(Base, TimestampMixin, SourceVersionMixin, ActivePublishMixin):
    __tablename__ = "rte_profile"

    rte_profile_id: Mapped[str] = mapped_column(String(36), primary_key=True, default=new_uuid)
