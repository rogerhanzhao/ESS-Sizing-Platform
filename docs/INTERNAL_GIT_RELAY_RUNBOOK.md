...
| 2026-07-22 | `ops/ubuntu-docker-coexist-20260311` | `ce97c9b` | `8aaa663` | Layout L2: concept site-array engine + report §9 (site plan, envelope estimate, code-basis table) + exec-summary envelope row. Internal LAN direct SSH; GitHub egress still blocked so relay used. Relay push, server `ff-only`, Docker rebuild/restart, HTTP 200 |
